# Week 12: Mock Interviews + Behavioral + Final Review

> **Duration:** 1 week | **Hours:** 18 hrs | **DSA Problems:** ~10 (hard + timed)
...
## 🧮 DSA Problems (Week 12 — Hard + Timed)
...
| Fri | Timed: any hard | Any folder | 45 min |
| Sat | Timed: any hard | Any folder | 45 min |
| Sat | Timed: any hard | Any folder | 45 min |
| Sun | Timed: any hard | Any folder | 45 min |
| Sun | Timed: any hard | Any folder | 45 min |

---

## 🎤 Mock Interview Plan (Sunday)

### Mock Interview 1: Android + Kotlin (45 min)
| Section | Time | Topics |
|---------|------|--------|
| Introduction | 5 min | Background, experience |
| Coding | 20 min | 1 medium DSA problem |
| Android | 10 min | Lifecycle, MVVM, Coroutines |
| Kotlin | 5 min | Null safety, sealed classes, Flows |
| Questions | 5 min | Candidate asks questions |

### Mock Interview 2: System Design (45 min)
| Section | Time | Topics |
|---------|------|--------|
| Requirements | 5 min | Clarify functional + non-functional |
| Estimation | 5 min | Traffic, storage, bandwidth |
| High-level | 10 min | Architecture diagram |
| Deep dive | 15 min | Database, API, scaling |
| Bottlenecks | 5 min | SPOF, trade-offs |
| Questions | 5 min | Candidate asks questions |

### Mock Interview 3: Behavioral + Compose (45 min)
| Section | Time | Topics |
|---------|------|--------|
| Behavioral | 15 min | STAR method, leadership, conflict |
| Compose | 10 min | State, recomposition, performance |
| Coding | 15 min | 1 medium DSA problem |
| Questions | 5 min | Candidate asks questions |
...
| Question | Key Points |
|----------|-----------|
| Tell me about yourself | Past → Present → Future, 2 min max |
| Why this company? | Specific reasons, not generic |
| Biggest challenge? | STAR, focus on YOUR action |
| Conflict with teammate? | Show empathy, data-driven resolution |
| Failure? | Take ownership, what you learned |
| Leadership? | Initiative, mentoring, driving results |

### Java Key Concepts
- **JVM Memory:** Heap (Young/Old gen), Stack, Metaspace, PC Register
- **GC:** Minor GC (Young gen), Major GC (Old gen), Full GC (entire heap)
- **Concurrency:** `synchronized` (intrinsic lock), `volatile` (visibility), `Atomic*` (CAS)
- **Collections:** ArrayList (dynamic array), LinkedList (doubly linked), HashMap (array + linked list + tree)
- **Generics:** Type erasure at compile time, `<? extends T>` (covariant), `<? super T>` (contravariant)
...
### Behavioral
- [ ] Prepared 5 STAR stories (challenge, failure, leadership, conflict, success)
- [ ] Can answer "Tell me about yourself" in 2 minutes
- [ ] Can answer "Why this company?" with specific reasons
- [ ] Practiced mock interviews at least 3 times

### Java
- [ ] Can explain JVM memory model
- [ ] Can explain GC algorithms (G1, ZGC)
- [ ] Can implement thread-safe singleton
- [ ] Can use CompletableFuture for async
- [ ] Can explain generics type erasure
- [ ] Can use Stream API (map, filter, collect, reduce)

### All Topics Review
- [ ] Reviewed all scenario-based files
- [ ] Can explain any topic from the 12-week schedule
- [ ] Solved 170+ DSA problems total
- [ ] Completed 3+ mock interviews
- [ ] Prepared questions to ask interviewer

### DSA Final Check
- [ ] Can solve easy in <15 min
- [ ] Can solve medium in <25 min
- [ ] Can solve hard in <40 min
- [ ] Comfortable with all patterns (DP, graph, tree, stack, sliding window, two pointer)
- [ ] Can write clean code on whiteboard/paper
...
|------|--------|
| Resume updated | [ ] |
| GitHub portfolio reviewed | [ ] |
| 3+ mock interviews completed | [ ] |
| All 250+ files reviewed | [ ] |
...
You've completed the 12-week interview preparation schedule! You've covered:
- **36 folders** with **250+ files**
- **170+ DSA problems**
- **216 hours** of study
- **All topics:** Kotlin, Java, Android, Compose, Flutter, Firebase, WebRTC, Security, Testing, CICD, Git, Design Patterns, SOLID, System Design, Behavioral, DSA
